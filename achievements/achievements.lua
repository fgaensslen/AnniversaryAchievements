...
do
    ...
    local wisdomHorde = quests:CreateAchievement('AN_WISDOM_KEEPER', 'AD_WISDOM_KEEPER', 40, '-Inv_Misc_Book_07', true)
    ...
    local wisdomAlliance = quests:CreateAchievement('AN_WISDOM_KEEPER', 'AD_WISDOM_KEEPER', 40, '-Inv_Misc_Book_07', true)
...
do
    ...
    local ach1 = add(arathi, 510, 'DEFILERS', 10, '-ability_warrior_battleshout')
    ach1:SetHordeOnly()
    local ach2 = add(alterac, 729, 'FROSTWOLF_CLAN', 10, '-Inv_Jewelry_FrostwolfTrinket_05')
    ach2:SetHordeOnly()
    local ach3 = add(warsong, 889, 'WARSONG_OUTRIDERS', 10, '-inv_jewelry_trinketpvp_02')
    ach3:SetHordeOnly()
    ...
    ach1 = add(arathi, 509, 'LEAGUE_OF_ARATHOR', 10, '-inv_jewelry_talisman_05')
...
do
    ...
    ach = fishing:CreateAchievement('AN_FISHING_BIG_SIZE', 'AD_FISHING_BIG_SIZE', 20, '-inv_misc_fish_09', true)
