SexyLib:InitLocalization('Anniversary Achievements', {
    ...
    AD_ALTERAC_KILLING_BLOWS = 'Make %d killing blows in one single battle for Alterac Valley and stay until end of the battle.',
    AN_ALTERAC_GRAVEYARD_ASSAULT = 'Undertaker',
    AD_ALTERAC_GRAVEYARD_ASSAULT = 'Assault a graveyard in one single battle for Alterac Valley and stay until the end of the battle.',
    AN_ALTERAC_GRAVEYARD_ASSAULTS = 'There are never enough Coffins',
    AD_ALTERAC_GRAVEYARD_ASSAULTS = 'Assault %d graveyards in one single battle for Alterac Valley and stay until the end of the battle.',
    AN_ALTERAC_GRAVEYARD_DEFEND = 'Guardian of the Deceased',
    AD_ALTERAC_GRAVEYARD_DEFEND = 'Defend a graveyard in one single battle for Alterac Valley and stay until the end of the battle.',
    AN_ALTERAC_GRAVEYARD_DEFENDS = 'Guardian of all Dead',
    AD_ALTERAC_GRAVEYARD_DEFENDS = 'Defend %d graveyards in one single battle for Alterac Valley and stay until the end of the battle.',
    AN_ALTERAC_TOWER_ASSAULT = 'Now it\'s mine!',
    AD_ALTERAC_TOWER_ASSAULT = 'Assault a tower in one single battle for Alterac Valley and stay until the end of the battle.',
    AN_ALTERAC_TOWER_ASSAULTS = 'Now it\'s all mine!',
    AD_ALTERAC_TOWER_ASSAULTS = 'Assault %d towers in one single battle for Alterac Valley and stay to the end of the battle.',
    AN_ALTERAC_TOWER_DEFEND = 'Tower Keeper',
    AD_ALTERAC_TOWER_DEFEND = 'Defend a tower in one single battle for Alterac Valley and stay until the end of the battle.',
    AN_ALTERAC_TOWER_DEFENDS = 'Towers Keeper',
    AD_ALTERAC_TOWER_DEFENDS = 'Defend %d towers in one single battle for Alterac Valley and stay until the end of the battle.',
    AN_ALTERAC_MINE_CAPTURE = 'Frozen Miner',
    AD_ALTERAC_MINE_CAPTURE = 'Assault a mine in one single battle for Alterac Valley and stay until the end of the battle.',
    AN_ALTERAC_MINE_CAPTURES = 'Frozen Pikeman',
    AD_ALTERAC_MINE_CAPTURES = 'Assault %d mines in one single battle for Alterac Valley and stay until the end of the battle.',

    AN_WARSONG_KILLS = 'Military Honor',
    AD_WARSONG_KILLS = 'Get %d honorable kills in one single battle for Warsong Gulch and stay until the end of the battle.',
    AN_WARSONG_FLAG_CAPTURE = 'Capture the Flag',
    AD_WARSONG_FLAG_CAPTURE = 'Personally carry and capture the flag in one single battle for Warsong Gulch and stay until the end of the battle.',
    AN_WARSONG_FLAG_CAPTURES = 'Great Flag Bearer',
    AD_WARSONG_FLAG_CAPTURES = 'Personally carry and capture %d flags in one single battle for Warsong Gulch and stay until the end of the battle.',
    AN_WARSONG_FLAG_RETURN = 'Don\'t touch!',
    AD_WARSONG_FLAG_RETURN = 'Return a flag as a defender in one single battle for Warsong Gulch and stay until the end of the battle.',
    AN_WARSONG_FLAG_RETURNS = 'Don\'t touch anything!',
    AD_WARSONG_FLAG_RETURNS = 'Return %d flags as a defender in one single battle for Warsong Gulch and stay until the end of the battle.',

    AN_ARATHI_BASE_ASSAULT = 'Conquistador',
    AD_ARATHI_BASE_ASSAULT = 'Assault a flag in one single battle for Arathi Basin and stay until the end of the battle.',
    AN_ARATHI_BASE_ASSAULTS = 'The famous conquistador',
    AD_ARATHI_BASE_ASSAULTS = 'Assault %d flags in one single battle for Arathi Basin and stay until the end of the battle.',
    AN_ARATHI_BASE_DEFEND = 'Sentry',
    AD_ARATHI_BASE_DEFEND = 'Defend a flags in one single battle for Arathi Basin and stay until the end of the battle.',
    AN_ARATHI_BASE_DEFENDS = 'Honorary sentry',
    AD_ARATHI_BASE_DEFENDS = 'Defend %d flags in one single battle for Arathi Basin and stay until the end of the battle.',
    ...
    AN_ANUBREKHAN_WITHOUT_MOBS = 'The bad Crypt Lord',
