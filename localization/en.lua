SexyLib:InitLocalization('Anniversary Achievements', {
    ...
    AN_ALLIANCE_KINGS_SLAYER = 'For The Alliance!',
    AD_ALLIANCE_KINGS_SLAYER = 'Slay the leaders of the Horde.',
    ...
    AD_HORDE_KINGS_SLAYER = 'Slay the leaders of the Alliance.',
    ...
    AN_COOKING_RECIPES_5 = 'Exploring goodies',
    AN_COOKING_RECIPES_10 = 'Nutritional life',
    AN_COOKING_RECIPES_25 = 'Food is my middle name',
    AN_COOKING_RECIPES_50 = 'Recipe master',
    AN_COOKING_RECIPES_75 = 'Adept of Azeroth dishes',
