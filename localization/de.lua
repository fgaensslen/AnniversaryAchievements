...
SexyLib:InitLocalization('Anniversary Achievements', {
    ...
    AD_ALTERAC_KILLING_BLOWS = 'Erreicht %d Todesstöße während einer einzigen Schlacht im Alteractal und bleibt bis zum Ende der Schlacht.',
    AN_ALTERAC_GRAVEYARD_ASSAULT = 'Alterac-Grabjäger',
    AD_ALTERAC_GRAVEYARD_ASSAULT = 'Nehmt einen Friedhof während einer einzigen Schlacht im Alteractal ein und bleibt bis zum Ende der Schlacht.',
    AN_ALTERAC_GRAVEYARD_ASSAULTS = 'Es fehlt an Särgen',
    AD_ALTERAC_GRAVEYARD_ASSAULTS = 'Nehmt %d Friedhöfe während einer einzigen Schlacht im Alteractal ein und bleibt bis zum Ende der Schlacht.',
    AN_ALTERAC_GRAVEYARD_DEFEND = 'Verteidiger der Verstorbenen',
    AD_ALTERAC_GRAVEYARD_DEFEND = 'Verteidigt einen Friedhof während einer einzigen Schlacht im Alteractal und bleibt bis zum Ende der Schlacht.',
    AN_ALTERAC_GRAVEYARD_DEFENDS = 'Verteidiger der Toten',
    AD_ALTERAC_GRAVEYARD_DEFENDS = 'Verteidigt %d Friedhöfe während einer einzigen Schlacht im Alteractal und bleibt bis zum Ende der Schlacht.',
    AN_ALTERAC_TOWER_ASSAULT = 'Nun gehört er mir!',
    AD_ALTERAC_TOWER_ASSAULT = 'Nehmt einen Turm während einer einzigen Schlacht im Alteractal ein und und bleibt bis zum Ende der Schlacht.',
    AN_ALTERAC_TOWER_ASSAULTS = 'Nun gehört ALLES mir!',
    AD_ALTERAC_TOWER_ASSAULTS = 'Nehmt %d Türme während einer einzigen Schlacht im Alteractal ein  und bleibt bis zum Ende der Schlacht.',
    AN_ALTERAC_TOWER_DEFEND = 'Turmwächter',
    AD_ALTERAC_TOWER_DEFEND = 'Verteidigt einen Turm während einer einzigen Schlacht im Alteractal und bleibt bis zum Ende der Schlacht.',
    AN_ALTERAC_TOWER_DEFENDS = 'Turmverteidiger',
    AD_ALTERAC_TOWER_DEFENDS = 'Verteidigt %d Türme während einer einzigen Schlacht im Alteractal und bleibt bis zum Ende der Schlacht.',
    AN_ALTERAC_MINE_CAPTURE = 'Gefrorener Bergmann',
    AD_ALTERAC_MINE_CAPTURE = 'Nehmt eine Mine während einer einzigen Schlacht im Alteractal ein und bleibt bis zum Ende der Schlacht.',
    AN_ALTERAC_MINE_CAPTURES = 'Gefrorener Pikenier',
    AD_ALTERAC_MINE_CAPTURES = 'Nehmt %d Minen während einer einzigen Schlacht im Alteractal ein und bleibt bis zum Ende der Schlacht.',

    AN_WARSONG_KILLS = 'Militärische Auszeichnung',
    AD_WARSONG_KILLS = 'Erreicht %d ehrenhafte Siege während einer einzigen Schlacht in der Kriegshymnenschlucht und bleibt bis zum Ende der Schlacht.',
    AN_WARSONG_FLAG_CAPTURE = 'Flaggenträger',
    AD_WARSONG_FLAG_CAPTURE = 'Ergreift und erobert die gegnerische Flagge während einer einzigen Schlacht in der Kriegshymnenschlucht und bleibt bis zum Ende der Schlacht.',
    AN_WARSONG_FLAG_CAPTURES = 'Großartiger Flaggenträger',
    AD_WARSONG_FLAG_CAPTURES = 'Ergreift und erobert %d gegnerische Flaggen während einer einzigen Schlacht in der Kriegshymnenschlucht und bleibt bis zum Ende der Schlacht.',
    AN_WARSONG_FLAG_RETURN = 'Fasst das nicht an!',
    AD_WARSONG_FLAG_RETURN = 'Bringt als Verteidiger eine Flagge während einer einzigen Schlacht in der Kriegshymnenschlucht zurück und bleibt bis zum Ende der Schlacht.',
    AN_WARSONG_FLAG_RETURNS = 'Hartnäckiger Verteidiger',
    AD_WARSONG_FLAG_RETURNS = 'Bringt als Verteidiger %d Flaggen während einer einzigen Schlacht in der Kriegshymnenschlucht zurück und bleibt bis zum Ende der Schlacht.',

    AN_ARATHI_BASE_ASSAULT = 'Konquistador',
    AD_ARATHI_BASE_ASSAULT = 'Erobert eine Basis während einer einzigen Schlacht im Arathibecken und bleibt bis zum Ende der Schlacht.',
    AN_ARATHI_BASE_ASSAULTS = 'Flaggenjagd',
    AD_ARATHI_BASE_ASSAULTS = 'Erobert %d Basen während einer einzigen Schlacht im Arathibecken und bleibt bis zum Ende der Schlacht.',
    AN_ARATHI_BASE_DEFEND = 'Wächter',
    AD_ARATHI_BASE_DEFEND = 'Verteidigt eine Basis während einer einzigen Schlacht im Arathibecken und bleibt bis zum Ende der Schlacht.',
    AN_ARATHI_BASE_DEFENDS = 'Ehrenhafter Wächter',
    AD_ARATHI_BASE_DEFENDS = 'Verteidigt %d Basen während einer einzigen Schlacht im Arathibecken und bleibt bis zum Ende der Schlacht.',
