...
SexyLib:InitLocalization('Anniversary Achievements', {
    ...
    AD_WARSONG_KILLS = 'Erreicht %d ehrenhafte Siege während einer Schlacht in der Kriegshymnenschlucht und bleibt bis zum Ende der Schlacht.',
    AN_WARSONG_FLAG_CAPTURE = 'Flaggenträger',
    AD_WARSONG_FLAG_CAPTURE = 'Ergreift und erobert die gegnerische Flagge während ihr in der Kriegshymnenschlucht kämpft und bleibt bis zum Ende der Schlacht.',
    AN_WARSONG_FLAG_CAPTURES = 'Großartiger Flaggenträger',
    AD_WARSONG_FLAG_CAPTURES = 'Ergreift und erobert %d gegnerische Flaggen während ihr in der Kriegshymnenschlucht kämpft und bleibt bis zum Ende der Schlacht.',
    AN_WARSONG_FLAG_RETURN = 'Fasst das nicht an!',
    AD_WARSONG_FLAG_RETURN = 'Bringt als Verteidiger eine Flagge während einer Schlacht in der Kriegshymnenschlucht zurück und bleibt bis zum Ende der Schlacht.',
    AN_WARSONG_FLAG_RETURNS = 'Hartnäckiger Verteidiger',
    AD_WARSONG_FLAG_RETURNS = 'Bringt als Verteidiger %d Flaggen zurück während ihr in der Kriegshymnenschlucht kämpft und bleibt bis zum Ende der Schlacht.',
