SexyLib:InitLocalization('Classic Achievements', {
    ...
    AN_PREPATCH_QUEST = 'Kampf um das Dunkle Portal',
    ...
    AN_ATTUNE_ARCATRAZ = 'Infiltrierung der Arkatraz',
    ...
    AN_ATTUNE_SSC = 'Zugang zur Höhle des Schlangenschreins',
    AD_ATTUNE_SSC = 'Erhaltet Zugang zur Höhle des Schlangenschreins.',
    AN_ATTUNE_EYE = 'Zugang zur Festung der Stürme',
    AD_ATTUNE_EYE = 'Erhaltet den Schlüssel der Stürme.',
    AN_ATTUNE_HYJAL = 'Die Phiolen der Ewigkeit',
    AD_ATTUNE_HYJAL = 'Besorgt Soridormi die Überreste von Vashjs Phiole von Lady Vashj in der Höhle des Schlangenschreins und die Überreste von Kaels Phiole von Kael\'thas Sonnenwanderer in der Festung der Stürme',
    AN_ATTUNE_BLACK_TEMPLE = 'Zutritt zum Schwarzen Tempel',
