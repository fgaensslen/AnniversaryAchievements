...
SexyLib:InitLocalization('Anniversary Achievements', {
    ...
    AC_MIDSUMMER_DESECRATION_HORDE_CRITERIA1 = 'Löschen Kalimdors',
    AC_MIDSUMMER_DESECRATION_HORDE_CRITERIA2 = 'Löschen der Scherbenwelt',
    AC_MIDSUMMER_DESECRATION_HORDE_CRITERIA3 = 'Löschen der östlichen Königreiche',
    ...
    AC_MIDSUMMER_DESECRATION_ALLIANCE_CRITERIA1 = 'Löschen Kalimdors',
    AC_MIDSUMMER_DESECRATION_ALLIANCE_CRITERIA2 = 'Löschen der Scherbenwelt',
    AC_MIDSUMMER_DESECRATION_ALLIANCE_CRITERIA3 = 'Löschen der östlichen Königreiche',
