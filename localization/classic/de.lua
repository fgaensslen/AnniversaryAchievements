...
SexyLib:InitLocalization('Anniversary Achievements', {
    achievement_earned = '&aErfolg von %s am %02d.%02d.%02d errungen',
    ...
    OPTION_MICROBUTTON_DESC = 'Wird diese Option aktiviert, so wird ein Addon-Button im Menü an der unteren Leiste angezeigt. Dies kann zu Anzeigefehlern führen, wenn andere Addons das Interface verändern. Deaktivieren zeigt stattdessen einen Button an der Minimap an.',
    ...
    AC_LUNAR_ELDERS_DUNGEONS_8727 = 'Urahne Farwhisper',
    AC_LUNAR_ELDERS_DUNGEONS_8619 = 'Urahne Morndeep',
    AC_LUNAR_ELDERS_DUNGEONS_8635 = 'Urahne Splitrock',
    AC_LUNAR_ELDERS_DUNGEONS_8713 = 'Urahne Starsong',
    AC_LUNAR_ELDERS_DUNGEONS_8644 = 'Urahne Stonefort',
    AC_LUNAR_ELDERS_DUNGEONS_8676 = 'Urahne Wildmane',
    ...
    AC_LUNAR_ELDERS_HORDE_8678 = 'Urahne Wheathoof in Thunder Bluff',
    AC_LUNAR_ELDERS_HORDE_8648 = 'Urahne Darkcore in Undercity',
    AC_LUNAR_ELDERS_HORDE_8677 = 'Urahnin Darkhorn in Orgrimmar',
    ...
    AC_LUNAR_ELDERS_ALLIANCE_8718 = 'Urahne Bladeswift in Darnassus',
    AC_LUNAR_ELDERS_ALLIANCE_8866 = 'Urahne Bronzebeard in Ironforge',
    AC_LUNAR_ELDERS_ALLIANCE_8646 = 'Urahne Hammershout in Stormwind',
    ...
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8636 = 'Urahne Rumblerock in der Brennenden Steppe',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8651 = 'Urahne Ironband in der Sengenden Schlucht',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8652 = 'Urahne Graveborn in Brill',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8674 = 'Urahne Winterhoof in Booty Bay',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8716 = 'Urahne Starglade in Zul\'Gurub',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8643 = 'Urahne Highpeak im Hinterland',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8675 = 'Urahnin Skychaser in Späherkuppe',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8649 = 'Urahne Stormbrow in Goldhain',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8650 = 'Urahne Snowcrown in der Kapelle des Hoffnungsvollen Lichts',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8642 = 'Urahne Silvervein in Thelsamar',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8645 = 'Urahne Obsidian am Grabmal',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8722 = 'Urahnin Meadowrun in den Westlichen Pestländern',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8647 = 'Urahne Bellowrage in den Verwüsteten Landen',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8653 = 'Urahne Goldwell in Kharanos',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8714 = 'Urahnin Moonstrike in Scholomance',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8688 = 'Urahne Windrun in den Östlichen Pestländern',
    AC_LUNAR_ELDERS_EASTERN_KINGDOMS_8683 = 'Urahnin Dawnstrider auf dem Flammenkamm',

    AN_LUNAR_ELDERS_KALIMDOR = 'Die Urahnen von Kalimdor',
    AD_LUNAR_ELDERS_KALIMDOR = 'Ehrt die Urahnen, die sich in Kalimdor befinden.',
    AC_LUNAR_ELDERS_KALIMDOR_8673 = 'Urahne Bloodhoof in Bloodhoof',
    AC_LUNAR_ELDERS_KALIMDOR_8723 = 'Urahne Nightwind im Teufelswald',
    AC_LUNAR_ELDERS_KALIMDOR_8684 = 'Urahne Dreamseer in Gadgetzan',
    AC_LUNAR_ELDERS_KALIMDOR_8726 = 'Urahne Brightspear in Winterspring',
    AC_LUNAR_ELDERS_KALIMDOR_8725 = 'Urahnin Riversong in Astranaar',
    AC_LUNAR_ELDERS_KALIMDOR_8715 = 'Urahne Bladeleaf in Dolanaar',
    AC_LUNAR_ELDERS_KALIMDOR_8681 = 'Urahne Thunderhorn in Un\'Goro',
    AC_LUNAR_ELDERS_KALIMDOR_8680 = 'Urahnin Windtotem in Ratchet',
    AC_LUNAR_ELDERS_KALIMDOR_8720 = 'Urahne Skygleam in Azshara',
    AC_LUNAR_ELDERS_KALIMDOR_8670 = 'Urahnin Runetotem in Klingenhügel',
    AC_LUNAR_ELDERS_KALIMDOR_8672 = 'Urahne Stonespire in Everlook',
    AC_LUNAR_ELDERS_KALIMDOR_8686 = 'Urahne High Mountain im Camp Taurajo',
    AC_LUNAR_ELDERS_KALIMDOR_8654 = 'Urahne Primestone in Silithus',
    AC_LUNAR_ELDERS_KALIMDOR_8671 = 'Urahnin Ragetotem in Tanaris',
    AC_LUNAR_ELDERS_KALIMDOR_8724 = 'Urahnin Morningdew an der Illusionenrennbahn',
    AC_LUNAR_ELDERS_KALIMDOR_8685 = 'Urahnin Mistwalker in Düsterbruch',
    AC_LUNAR_ELDERS_KALIMDOR_8721 = 'Urahnin Starweave in Auberdine',
    AC_LUNAR_ELDERS_KALIMDOR_8717 = 'Urahne Moonwarden in Crossroads',
